  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="flex flex-col justify-start gap-1">
        <p className="overflow-hidden whitespace-nowrap text-sm font-semibold text-white sm:text-base lg:text-lg">
          {game.name}
        </p>
        <div className="flex items-center justify-between">
          <div className="flex flex-1 items-center justify-start gap-1">
            <p className="text-sm font-medium text-white sm:text-base">{game.rating}</p>
            <svg
          ...
          <button
            className="rounded-sm bg-gradient-to-r from-blue-400 to-blue-600 px-2 shadow-md hover:from-blue-300 hover:to-blue-500"
            onClick={handleClick}
          >
