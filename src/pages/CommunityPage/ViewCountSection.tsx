...
const YouTubeCount = ({ displayedGame }: ViewCountSectionProps): ReactElement => {
  return (
    <div className="flex items-center gap-1">
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 50 50"} fill={"#ffff"} className="h-11 w-11">
        <path
          d={
      ...
      <div className="flex flex-col">
        <p className="text-lg font-semibold">{"YOUTUBE COUNT"}</p>
...
const TwitchCount = ({ displayedGame }: ViewCountSectionProps): ReactElement => {
  return (
    <div className="flex items-center gap-1">
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 50 50"} className="h-9 w-9" fill={"#ffff"}>
        <path
          d={
      ...
      <div className="flex flex-col">
        <p className="text-lg font-semibold">{"TWITCH COUNT"}</p>
        <div className="text-gray-400">
...
const RedditCount = ({ displayedGame }: ViewCountSectionProps): ReactElement => {
  return (
    <div className="flex items-center gap-1">
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 50 50"} className="h-11 w-11" fill={"#ffff"}>
        <path
          d={
      ...
      <div className="flex flex-col">
        <p className="text-lg font-semibold">{"REDDIT COUNT"}</p>
        <div className="text-gray-400">
