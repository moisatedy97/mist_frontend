  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 sm:gap-8">
      ...
      <div className="flex items-center gap-4">
        <Input
          value={otp}
          className="h-14 w-[8rem] space-x-4 rounded border border-gray-800 bg-gray-800 px-5 py-3 text-center text-3xl tracking-widest text-white shadow-md outline-none hover:bg-gray-700 sm:w-[148px] sm:px-7"
          placeholder={"OTP"}
...
const ValidateOtpButton = ({ otp }: ValidateOtpButtonProps) => {
  ...
  return (
    <button
      className="h-11 w-24 self-center rounded-sm bg-gradient-to-r from-blue-400 to-blue-600 font-normal text-white shadow-md hover:from-blue-300 hover:to-blue-500"
      onClick={handleClick}
    >
      {"VALIDATE"}
    </button>
